...
- [TypeScript]()
  ...
  - [TypeScript Style Guide](./languages/ts/style-guide.md)
  - [tsup](./languages/ts/tsup.md)
  - [Vitest](./languages/ts/vitest.md)

# Tools

- [AI & ML]()
  - [Agents.md](./tools/ai-ml/agents.md)
  - [Claude Code](./tools/ai-ml/claude.md)
...
- [Network & Proxy]()
  - [Nginx](./tools/network-proxy/nginx.md)
- [System & OS]()
  - [Aerospace](./tools/system-os/aerospace.md)
  - [chezmoi](./tools/system-os/chezmoi.md)
...
- [VCS]()
  - [GitHub CLI](./tools/vcs/github-cli.md)
  - [GnuPG: Generating a GPG Key Pair](./tools/vcs/gnupg.md)
